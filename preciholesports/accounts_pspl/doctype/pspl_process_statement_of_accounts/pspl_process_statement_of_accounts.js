...
frappe.ui.form.on('PSPL Process Statement Of Accounts', {
	...
	fetch_suppliers: function(frm) {
		if(frm.doc.supplier_group){
			frappe.call({
				method: "preciholesports.accounts_pspl.doctype.pspl_process_statement_of_accounts.pspl_process_statement_of_accounts.fetch_suppliers",
				args: {
		...
		if(!frm.doc.__islocal) {
			...
			frm.add_custom_button(__('Download'), function(){
				var url = frappe.urllib.get_full_url(
					'/api/method/preciholesports.accounts_pspl.doctype.pspl_process_statement_of_accounts.pspl_process_statement_of_accounts.download_statements?'
