...
def get_report_pdf(doc, consolidated=True):
	...
	template_path = (
		"preciholesports/accounts_pspl/doctype/pspl_process_statement_of_accounts/pspl_process_statement_of_accounts.html"
	)
...
def send_emails(document_name, from_scheduler=False):
	signature_template = (
		"preciholesports/accounts_pspl/doctype/pspl_process_statement_of_accounts/email_signature.html"
	)
